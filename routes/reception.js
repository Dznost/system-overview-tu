...
router.get("/reservations/create-guest", receptionController.getCreateGuestReservationForm)
router.post("/reservations/create-guest", receptionController.createGuestReservation)
...
router.post("/reservations/:id/confirm-guest-payment", receptionController.confirmGuestReservationPayment)
