...
const paymentSchema = new mongoose.Schema({
  ...
  paymentMethod: { type: String, enum: ["bank", "cash", "transfer", "wallet"], required: true },
  // "refunded" keeps the record for auditing but removes it from revenue reports,
  // which only aggregate payments with status "completed".
